...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:cisco123@localhost/drupaldb?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://drupaluser:cisco123@localhost/civicrmdb?new_link=true');
}
...
$civicrm_root = '/usr/share/nginx/html/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/usr/share/nginx/html/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '3a7c723c7b50453f2b643015c5ab7970');
}
...
// define( 'CIVICRM_MAIL_LOG', '/usr/share/nginx/html/sites/default/files/civicrm/templates_c/mail.log');
// }
