...
if (!empty($_SERVER['PRESSFLOW_SETTINGS'])) {
  ...
  if (!empty($env['conf']['pantheon_binding'])) {
    ...
    define( 'CIVICRM_SITE_KEY', '23db3f83498f05574eb907d1fde40c9a' );
...
define( 'CIVICRM_UF_DSN'           , 'mysql://drupaldb:ZAQ!2wsx@localhost/drupaldb?new_link=true' );
...
define( 'CIVICRM_DSN'          , 'mysql://civicrmdb:ZAQ!2wsx@localhost/civicrmdb?new_link=true' );
...
$civicrm_root = '/usr/share/nginx/html/civicrm/profiles/civicrm_starterkit/modules/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/usr/share/nginx/html/civicrm/sites/default/files/civicrm/templates_c/' );
 ...
 *
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://10.78.163.114/civicrm/' );
 ...
 */
// define( 'CIVICRM_MAIL_LOG', '/usr/share/nginx/html/civicrm/sites/default/files/civicrm/templates_c//mail.log' );
